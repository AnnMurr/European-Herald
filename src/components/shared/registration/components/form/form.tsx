        ...
        <FormControl
            ...
            <Label>Password
                <TextField {...register('password', {
                    required: true,
                    pattern: {
                        value: /^(?=\S*?[0-9])(?=\S*?[?!@#$%^&*])(?=\S*?[a-z-а-я])(?=\S*?[A-Zа-яА-Я])\S+$/,
                        message: 'Password must contain at least one digit, one special character \'!@#$%^&*\', one lowercase letter, one uppercase letter, and should not contain any spaces.'
                    },
                    minLength: {
                        value: 6,
