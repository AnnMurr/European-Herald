import { TextField, Button as MuiButton, FormControl, FormHelperText } from "@mui/material";
...
export const Form = () => {
    ...
    const togglePasswordType = () => typeOfPassword === 'password' ? setTypeOfPassword('text') : setTypeOfPassword('password')
